...
export const TableCommunities = ({ communities }: { communities: CommunityWithBrotherCount[] }) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      {communities.map(({ id, number_community, responsables, level_paso, count_brothers }) => (
        <div key={id} className="grid grid-cols-[80px_2fr_2fr_2fr_1fr] gap-4 p-2 hover:bg-neutral-200 odd:bg-white even:bg-neutral-100">
          ...
          <div className="text-center">{count_brothers}</div>
          <div className="actions flex justify-center gap-2">
            ...
            <button className="atn-btn" title="Editar Comunidad" onClick={(e) => handleEditComm(e, { id, number_community, responsables, level_paso })}>
